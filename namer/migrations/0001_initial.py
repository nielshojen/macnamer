    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.ForeignKey(to='namer_computergroup', on_delete=models.CASCADE, max_length=200, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('computergroup', models.ForeignKey(to='namer_computergroup', on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ['network'],
            },
